    ...
    return (
      <div className="space-y-6">
        ...
        <ConfirmDialog
          ...
          title="Delete Client"
          message={`Are you sure you want to delete "${selectedClient.practice_name || selectedClient.name}"? This action cannot be undone. All claims, appeals, notes, and associated data will be permanently removed.`}
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmDialog
        isOpen={showDeleteConfirm}
        title="Delete Client"
        message={`Are you sure you want to delete "${clientToDelete?.practice_name || clientToDelete?.name || 'this client'}"? This action cannot be undone. All claims, appeals, notes, and associated data will be permanently removed.`}
        confirmLabel="Delete Client"
        cancelLabel="Cancel"
        confirmVariant="danger"
        onConfirm={handleDeleteClient}
